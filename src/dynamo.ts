...
//const metadataKey = 'metadata#<guild>';

export const tables = {
    User: dynamo.define('Postman.User', {
        tableName: 'Postman',
        hashKey : 'key',
        timestamps : true,
    ...
    History: dynamo.define('Postman.History', {
        tableName: 'Postman',
        hashKey : 'key',
        timestamps : true,
    ...
    Metadata: dynamo.define('Postman.Metadata', {
        tableName: 'Postman',
        hashKey : 'key',
        timestamps : true,
        ...
        schema : {
            key: Joi.string(),
            guild: Joi.number(),
            authorized_users: Joi.array().items(Joi.number()),
            active_users: Joi.array().items(Joi.number()),
